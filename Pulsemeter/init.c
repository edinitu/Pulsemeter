...
PORTA=0x0F; // 4 LSB of port A need to be high for 7seg display to stay off
DDRA=0x0F;
...
PORTC=0x00;
DDRC=0xFF; // write to 7segment display
...
ACSR=0x80;
ADCSRB=0x00;
//ADMUX = ADMUX_NOCHANNEL | (4 & 0b00000111); // channel selection
ADCSRA=0b10010101;
DIDR1=0x00;
